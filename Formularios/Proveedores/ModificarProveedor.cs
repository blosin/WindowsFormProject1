...
namespace Gestionador.Formularios.Proveedores
{
    public partial class ModificarProveedor : Form
    {
        ...
        public ModificarProveedor(string id)
        {
            InitializeComponent();
            ...
            proveedor = repositorioProveedores.ObtenerProveedor(id);
        ...
        private void ModificarProveedor_Load(object sender, EventArgs e)
        {
            ...
            cmbRubro.SelectedValue = proveedor.rubro;
            cmbIVA.SelectedValue = proveedor.iva;
            txtCuit.Text = proveedor.cuit;
            txtTelefono.Text = proveedor.telFijo;
            txtCelular.Text = proveedor.telCel;
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            {
                if(repositorioProveedores.Actualizar(proveedor))
                    {
