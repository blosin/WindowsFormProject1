...
{
    public partial class AltaDetalleGastos : Form
    {
        RepositorioDetalleGastos repositorioDetalleGastos;
        public AltaDetalleGastos()
        {
        ...
        private void btnAceptar_Click(object sender, EventArgs e)
        {
            ...
            DataTable tablatemporal = repositorioDetalleGastos.SoyDetalleExistente(detalle.nombre);
            if (tablatemporal.Rows.Count == 0)
            {
                if (repositorioDetalleGastos.Guardar(detalle))
                {
