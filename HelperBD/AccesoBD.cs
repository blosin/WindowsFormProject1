...
namespace Gestionador.HelperBD
{
    class AccesoBD
    {
        ...
        //se crea uan variable local a la clase <cadena_conexio> para alojar la cadena de conexiónJOEL-PC\JOELPC
        ...
        //Data Source=JOEL-PC\JOELPC;Initial Catalog=Kiosko;Integrated Security=True
        ...
        //workstation id=pav1-db.mssql.somee.com;packet size=4096;user id=milizc_SQLLogin_1;pwd=2s9o1yeexo;data source=pav1-db.mssql.somee.com;persist security info=False;initial catalog=pav1-db
        string cadena_conexion = "Provider=SQLNCLI11;Data Source=JOEL-PC\\JOELPC;Initial Catalog=Kiosko;Integrated Security=SSPI";
